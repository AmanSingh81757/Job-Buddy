    ...
    <section className="w-full h-screen flex items-center justify-center bg-gradient-to-tl from-purple-100 to-blue-100 p-5">
      <Card className="shadow-xl">
        <CardHeader className="space-y-1">
          ...
          <CardDescription>
            Login with your Github aur Google account
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4">
          ...
          <div className="grid grid-cols gap-6">
              <Button variant="outline" onClick={()=>signIn("github", { redirectTo: "/dashboard" })}>
                <Github className="mr-2 h-4 w-4" />
                Sign In with Github
              </Button>
            <Button variant="outline" onClick={()=>signIn("google", { redirectTo: "/dashboard" })}>
              <svg
